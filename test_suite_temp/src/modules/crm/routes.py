# -*- coding: utf-8 -*-
"""
Registro de rotas OpenAPI 3.1 para o módulo 'crm'.
"""
...
def registrar_rotas(service: Any = None):
    ...
    @registry.get(
        "/api/crm",
        summary="Listar todos os itens do módulo crm",
        tags=[tag_name],
        description="Retorna a lista de registros cadastrados no módulo crm.",
        query_params=[
    ...
    @registry.get(
        "/api/crm/obter",
        summary="Obter item de crm por ID",
        tags=[tag_name],
        description="Retorna os detalhes completos de um registro do módulo crm.",
        query_params=[
    ...
    @registry.post(
        "/api/crm/criar",
        summary="Criar novo item no módulo crm",
        tags=[tag_name],
        ...
        body_example={"titulo": "Novo Registro Crm", "descricao": "Descrição detalhada", "status": "ativo", "dados": {"prioridade": "alta"}},
        responses={
    ...
    @registry.post(
        "/api/crm/atualizar",
        summary="Atualizar item do módulo crm",
        tags=[tag_name],
        ...
        body_example={"id": 1, "titulo": "Crm Atualizado", "status": "concluido"},
        responses={
    ...
    @registry.post(
        "/api/crm/deletar",
        summary="Remover item do módulo crm",
        tags=[tag_name],
