# -*- coding: utf-8 -*-
"""
Registro de rotas OpenAPI 3.1 para o módulo 'erp'.
"""
...
def registrar_rotas(service: Any = None):
    ...
    @registry.get(
        "/api/erp",
        summary="Listar todos os itens do módulo erp",
        tags=[tag_name],
        description="Retorna a lista de registros cadastrados no módulo erp.",
        query_params=[
    ...
    @registry.get(
        "/api/erp/obter",
        summary="Obter item de erp por ID",
        tags=[tag_name],
        description="Retorna os detalhes completos de um registro do módulo erp.",
        query_params=[
    ...
    @registry.post(
        "/api/erp/criar",
        summary="Criar novo item no módulo erp",
        tags=[tag_name],
        ...
        body_example={"titulo": "Novo Registro Erp", "descricao": "Descrição detalhada", "status": "ativo", "dados": {"prioridade": "alta"}},
        responses={
    ...
    @registry.post(
        "/api/erp/atualizar",
        summary="Atualizar item do módulo erp",
        tags=[tag_name],
        ...
        body_example={"id": 1, "titulo": "Erp Atualizado", "status": "concluido"},
        responses={
    ...
    @registry.post(
        "/api/erp/deletar",
        summary="Remover item do módulo erp",
        tags=[tag_name],
