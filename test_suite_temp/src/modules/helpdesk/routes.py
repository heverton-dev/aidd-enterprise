# -*- coding: utf-8 -*-
"""
Registro de rotas OpenAPI 3.1 para o módulo 'helpdesk'.
"""
...
def registrar_rotas(service: Any = None):
    ...
    @registry.get(
        "/api/helpdesk",
        summary="Listar todos os itens do módulo helpdesk",
        tags=[tag_name],
        description="Retorna a lista de registros cadastrados no módulo helpdesk.",
        query_params=[
    ...
    @registry.get(
        "/api/helpdesk/obter",
        summary="Obter item de helpdesk por ID",
        tags=[tag_name],
        description="Retorna os detalhes completos de um registro do módulo helpdesk.",
        query_params=[
    ...
    @registry.post(
        "/api/helpdesk/criar",
        summary="Criar novo item no módulo helpdesk",
        tags=[tag_name],
        ...
        body_example={"titulo": "Novo Registro Helpdesk", "descricao": "Descrição detalhada", "status": "ativo", "dados": {"prioridade": "alta"}},
        responses={
    ...
    @registry.post(
        "/api/helpdesk/atualizar",
        summary="Atualizar item do módulo helpdesk",
        tags=[tag_name],
        ...
        body_example={"id": 1, "titulo": "Helpdesk Atualizado", "status": "concluido"},
        responses={
    ...
    @registry.post(
        "/api/helpdesk/deletar",
        summary="Remover item do módulo helpdesk",
        tags=[tag_name],
